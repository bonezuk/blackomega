...
section  "Black Omega" SecDummy
	...
	file "${OMEGAPATH}\bin\Qt6DBus.dll"
	file "${OMEGAPATH}\bin\Qt6Gui.dll"
	file "${OMEGAPATH}\bin\Qt6Help.dll"
	file "${OMEGAPATH}\bin\Qt6Network.dll"
	file "${OMEGAPATH}\bin\Qt6PrintSupport.dll"
	file "${OMEGAPATH}\bin\Qt6Qml.dll"
	file "${OMEGAPATH}\bin\Qt6Quick.dll"
	file "${OMEGAPATH}\bin\Qt6Sql.dll"
	file "${OMEGAPATH}\bin\Qt6Test.dll"
...
section "Uninstall"
	...
	delete "$INSTDIR\bin\Qt6DBus.dll"
	delete "$INSTDIR\bin\Qt6Gui.dll"
	delete "$INSTDIR\bin\Qt6Help.dll"
	delete "$INSTDIR\bin\Qt6Network.dll"
	delete "$INSTDIR\bin\Qt6PrintSupport.dll"
	delete "$INSTDIR\bin\Qt6Qml.dll"
	delete "$INSTDIR\bin\Qt6Quick.dll"
	delete "$INSTDIR\bin\Qt6Sql.dll"
	delete "$INSTDIR\bin\Qt6Test.dll"

...
TEST(FormatType, lsb2msb)
{
	for(tint i = 0; i < 256; i++)
	{
		tubyte u, v;
		
		u = static_cast<tubyte>(i);
		v = lsb2msb(u);
		
		ASSERT_EQ((u & 0x01) ? 1 : 0, (v & 0x80) ? 1 : 0);
		ASSERT_EQ((u & 0x02) ? 1 : 0, (v & 0x40) ? 1 : 0);
		ASSERT_EQ((u & 0x04) ? 1 : 0, (v & 0x20) ? 1 : 0);
		ASSERT_EQ((u & 0x08) ? 1 : 0, (v & 0x10) ? 1 : 0);
		ASSERT_EQ((u & 0x10) ? 1 : 0, (v & 0x08) ? 1 : 0);
		ASSERT_EQ((u & 0x20) ? 1 : 0, (v & 0x04) ? 1 : 0);
		ASSERT_EQ((u & 0x40) ? 1 : 0, (v & 0x02) ? 1 : 0);
		ASSERT_EQ((u & 0x80) ? 1 : 0, (v & 0x01) ? 1 : 0);
	}
}

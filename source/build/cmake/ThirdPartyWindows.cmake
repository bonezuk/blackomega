...
else ((${CMAKE_GENERATOR} MATCHES "NMake Makefiles") OR (${CMAKE_GENERATOR} MATCHES "Ninja"))
	set(TIGER_BIN_INSTALL "${TIGER_ROOT_DIRECTORY}/${CMAKE_BUILD_TYPE}")
...
if (OMEGA_MSVC12 OR OMEGA_MSVC16)
	...
	set(REDIST_LIB_DIR "${BLACKOMEGA_UTILS}/redist/${REDIST_DIR}/${CMAKE_BUILD_TYPE}")
...
file(GLOB QTCORE5COMPAT_LIBRARY_FILES "${QT_HOME}/bin/${QT_CORE5COMPACT_LIBNAME}.*")
file(COPY ${QTCORE5COMPAT_LIBRARY_FILES} DESTINATION ${TIGER_BIN_INSTALL})

message("Copy Qt6Help")
file(GLOB QTHELP_LIBRARY_FILES "${QT_HOME}/bin/${QT_HELP_LIBNAME}.*")
file(COPY ${QTHELP_LIBRARY_FILES} DESTINATION ${TIGER_BIN_INSTALL})

message("Copy Qt6SQL")
file(GLOB QTSQL_LIBRARY_FILES "${QT_HOME}/bin/${QT_SQL_LIBNAME}.*")
file(COPY ${QTSQL_LIBRARY_FILES} DESTINATION ${TIGER_BIN_INSTALL})

message("Copy Qt6PrintSupport")
file(GLOB QTPRINTSUPPORT_LIBRARY_FILES "${QT_HOME}/bin/${QT_PRINTSUPPORT_LIBNAME}.*")
...
if (NOT OMEGA_MSVC12)
	foreach (QTPLUGIN_QML_FILE ${QTPLUGIN_QML_FILES})
		file(COPY "${QT_HOME}/qml/QtQuick/${QTPLUGIN_QML_FILE}" DESTINATION "${TIGER_INSTALL}/qml/QtQuick.2")

...
if (OMEGA_WIN32)
    ...
    elseif ((${CMAKE_GENERATOR} MATCHES "NMake Makefiles") OR (${CMAKE_GENERATOR} MATCHES "Ninja"))
        message("Set MSVC16 for nmake")
        set(OMEGA_MSVC16 TRUE)
        set(OMEGA_MSVC12 FALSE)
    else (MSVC_VERSION GREATER_EQUAL 1200 AND MSVC_VERSION LESS 1300)
        message("No MSVC, default MSVC12")
        set(OMEGA_MSVC12 TRUE)
        set(OMEGA_MSVC16 FALSE)
...
if (NOT OMEGA_WIN32)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        set(TIGER_COMPILER "GCC")
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        set(TIGER_COMPILER "Clang")
    endif()
endif()
...
if (${TIGER_SYSTEM_DEPS})
    ...
    if (NOT BLACKOMEGA_PREFIX)
        set (BLACKOMEGA_PREFIX "${BLACKOMEGA_UTILS}/usr")
    endif()
...
elseif (OMEGA_MACOSX)
    ...
    if (NOT CMAKE_SYSTEM_VERSION VERSION_LESS "20.0.0")
        find_library(URLTYPE_FRAMEWORK_UNIT UniformTypeIdentifiers)
    endif (NOT CMAKE_SYSTEM_VERSION VERSION_LESS "20.0.0")
elseif (OMEGA_LINUX)
    include(FindALSA)

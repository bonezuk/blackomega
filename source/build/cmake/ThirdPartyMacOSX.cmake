...
file(GLOB QTNETWORK_LIBRARY_FILES "${QT_HOME2}/lib/${QT_NETWORK_LIBNAME}.*")
...
message("Copy QtQml")
file(GLOB QTQML_LIBRARY_FILES "${QT_HOME2}/lib/${QT_QML_LIBNAME}.*")
file(COPY ${QTQML_LIBRARY_FILES} DESTINATION ${TIGER_BIN_INSTALL})

message("Copy QtQuick")
file(GLOB QTQUICK_LIBRARY_FILES "${QT_HOME2}/lib/${QT_QUICK_LIBNAME}.*")
file(COPY ${QTQUICK_LIBRARY_FILES} DESTINATION ${TIGER_BIN_INSTALL})

message("Copy QtDBus")
file(GLOB QTDBUS_LIBRARY_FILES "${QT_HOME2}/lib/${QT_DBUS_LIBNAME}.*")
...
copy_rename_plugin_files("libqcertonlybackend" "tls")
copy_rename_plugin_files("libqopensslbackend" "tls")
copy_rename_plugin_files("libqsecuretransportbackend" "tls")
